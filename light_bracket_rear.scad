...
hbar_len = 30;   // mm:  the length of the horizontal stub of 'handlebar'
hbar_len2 = 30;  // mm:  length of vertical stub of 'handlebar'
bracket_th = 1.5;	//mm
bracket_h  = 30;	//mm
clamp_w = 10;	//mm
clamp_th = 10;	//mm
...
difference() {
	union() {
		...
		// make the vertical handlebar stub
		translate([hbar_len,0,bracket_h/2]) rotate(90,[0,0,1])
			cylinder(r=hbar_dia/2,h=hbar_len2+strut_dia/2);
	}
